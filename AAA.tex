...
The algorithm constructs a sequence of rational approximants $r_m$ of increasing degree by selecting support points $\{z_1,\dots,z_m\}\subset Z$ adaptively and computing associated weights $w_1,\dots,w_m$.
